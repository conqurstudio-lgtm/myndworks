...
const BRAND = {
  ...
  gradientCyan: "linear-gradient(135deg, #06b6d4, #e91e8c)",
};
...
const SERVICES: Service[] = [
  ...
  { icon: "🏢", title: "Corporate Wellness", desc: "Team building, workshops, debriefing sessions, healthy and wellness programs, and public speaking in wellness for organisations." },
  ...
  { icon: "🎤", title: "Workshops & Training", desc: "Engaging wellness workshops and professional training programmes designed to build resilience and mental fitness." },
];
...
const FAQS: FaqItem[] = [
  ...
  { q: "Do you offer corporate packages?", a: "Yes! We offer tailored corporate wellness programmes including team building, workshops, debriefing sessions, and public speaking in wellness." },
];
...
const STATS = [
  ...
  { value: "8", label: "Specialist Therapists" },
];
...
function Navbar() {
  ...
  return (
    <nav style={{ fontFamily: "'DM Sans', sans-serif" }}
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-white shadow-sm" : "bg-white/90 backdrop-blur-md"}`}>
      <div className="max-w-6xl mx-auto px-6 flex items-center justify-between" style={{ height: "72px" }}>
        <button onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })} className="flex items-center gap-2">
          <div className="w-9 h-9 rounded-xl flex items-center justify-center shadow-md" style={{ background: BRAND.gradient }}>
          ...
          <span className="text-xl font-bold text-slate-900">
            <span style={{ color: BRAND.pink }}>Mynd</span>Works
          </span>
        </button>
        ...
        <div className="hidden md:flex items-center gap-1">
          ...
          <button onClick={() => go("#contact")}
            className="ml-3 px-5 py-2.5 rounded-full text-white text-sm font-semibold shadow-md hover:shadow-lg hover:scale-105 transition-all"
  ...
  return (
    <section className="relative overflow-hidden bg-white" style={{ minHeight: "100vh", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-32 -right-32 w-96 h-96 rounded-full opacity-10 blur-3xl" style={{ background: BRAND.pink }}/>
        <div className="absolute top-1/2 right-0 w-72 h-72 rounded-full opacity-10 blur-3xl" style={{ background: BRAND.orange }}/>
        <div className="absolute bottom-0 left-0 w-64 h-64 rounded-full opacity-10 blur-3xl" style={{ background: BRAND.cyan }}/>
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 flex items-center" style={{ minHeight: "100vh" }}>
        <div className="grid md:grid-cols-2 gap-12 items-center w-full py-32">
          {/* Left */}
          <div>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium mb-8 border border-pink-100"
              style={{ background: "#fff0f7", color: BRAND.pink }}>
              <span className="w-2 h-2 rounded-full animate-pulse" style={{ background: BRAND.pink }}/>
              Professional Mental Health Support
            </div>
            <h1 className="font-bold text-slate-900 leading-tight mb-4" style={{ fontSize: "clamp(2.2rem, 5vw, 3.5rem)" }}>
              <span style={{ color: BRAND.pink }}>Feel better.</span>{" "}
              <span className="text-slate-800">Think clearer.</span>
            </h1>
            <p className="text-xl font-semibold mb-4" style={{ color: BRAND.orange }}>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button onClick={() => document.querySelector("#services")?.scrollIntoView({ behavior: "smooth" })}
                className="px-8 py-4 rounded-2xl font-semibold text-base border-2 border-slate-200 text-slate-700 hover:bg-slate-50 transition-all">
                Explore Services
              </button>
            </div>
              ...
              {["Fully Confidential", "In-person & Online", "Free First Consultation"].map(t => (
                <div key={t} className="flex items-center gap-2 text-sm text-slate-500">
                  <div className="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0"
                    ...
                    <svg className="w-3 h-3" style={{ color: BRAND.pink }} fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="relative hidden md:block">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl">
              ...
              />
              <div className="absolute inset-0" style={{ background: "linear-gradient(to top, rgba(233,30,140,0.15), transparent)" }}/>
            </div>
            <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl shadow-xl p-5 border border-slate-100">
              <p className="text-3xl font-bold" style={{ color: BRAND.pink }}>2,000+</p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {STATS.map((s, i) => (
            <Reveal key={s.label} delay={i * 80} className="text-center">
              <p className="text-4xl font-bold mb-1" style={{ background: BRAND.gradient, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
                {s.value}
              </p>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <Reveal className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4">
            Support for{" "}
            <span style={{ fontFamily: "'DM Serif Display', serif", color: BRAND.pink, fontStyle: "italic", fontWeight: 400 }}>
              every journey
            </span>
          </h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {SERVICES.map((s, i) => (
            <Reveal key={s.title} delay={i * 60}>
              <div className="group p-6 rounded-2xl border border-slate-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer bg-white h-full"
                style={{ borderTopWidth: "3px", borderTopColor: i % 2 === 0 ? BRAND.pink : BRAND.orange }}>
                <div className="w-11 h-11 rounded-xl flex items-center justify-center text-2xl mb-4"
                  style={{ background: "#fff0f7" }}>
                  {s.icon}
                </div>
                <h3 className="text-base font-bold text-slate-900 mb-2 group-hover:transition-colors" style={{}}>
                  {s.title}
                </h3>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <Reveal className="relative">
            <div className="relative rounded-3xl overflow-hidden shadow-xl">
              <img
                ...
                style={{ height: "460px" }}
              />
              <div className="absolute inset-0" style={{ background: "linear-gradient(to top, rgba(233,30,140,0.1), transparent)" }}/>
            </div>
            <div className="absolute -bottom-5 -right-5 bg-white rounded-2xl shadow-lg p-5 border border-slate-100">
              <div className="flex items-center gap-3 mb-2">
                <div className="w-8 h-8 rounded-full flex items-center justify-center text-sm" style={{ background: "#fff0f7" }}>💜</div>
          ...
          <Reveal delay={200}>
            <span className="inline-block px-4 py-1.5 rounded-full text-sm font-semibold uppercase tracking-wide mb-5"
              style={{ background: "#fff7ed", color: BRAND.orange }}>
              About MyndWorks
            </span>
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 leading-tight">
              Rooted in empathy,{" "}
              <span style={{ fontFamily: "'DM Serif Display', serif", color: BRAND.orange, fontStyle: "italic", fontWeight: 400 }}>
                driven by science
              </span>
            </h2>
            ...
            <button onClick={() => document.querySelector("#contact")?.scrollIntoView({ behavior: "smooth" })}
              className="px-7 py-3.5 rounded-xl text-white font-semibold hover:shadow-lg hover:scale-[1.02] transition-all"
              style={{ background: BRAND.gradient }}>
              Start Your Journey
            </button>
          </Reveal>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="rounded-3xl p-8 md:p-10 border border-slate-100 shadow-sm" style={{ background: "#fafafa" }}>
            <div className="flex gap-1 mb-6">
              {[...Array(5)].map((_, i) => (
                <svg key={i} className="w-5 h-5" style={{ color: BRAND.orange }} fill="currentColor" viewBox="0 0 20 20">
            ...
            {TESTIMONIALS.map((_, i) => (
              <button key={i} onClick={() => setActive(i)}
                ...
                style={{
                  ...
                  height: "10px",
                  background: active === i ? BRAND.pink : "#e2e8f0",
                }}/>
            ))}
          </div>
        </div>
  ...
  return (
    <section id="faq" className="py-24" style={{ background: "#fafafa", fontFamily: "'DM Sans', sans-serif" }}>
      <div className="max-w-3xl mx-auto px-6">
        <Reveal className="text-center mb-16">
          <span className="inline-block px-4 py-1.5 rounded-full text-sm font-semibold uppercase tracking-wide mb-4"
            style={{ background: "#e0f9ff", color: BRAND.cyan }}>
            Common Questions
          </span>
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4">
            Got{" "}
            <span style={{ fontFamily: "'DM Serif Display', serif", color: BRAND.cyan, fontStyle: "italic", fontWeight: 400 }}>
              questions?
            </span>
          </h2>
        ...
        <div className="space-y-3">
          {FAQS.map((f, i) => (
            <Reveal key={i} delay={i * 50}>
              <div className={`rounded-2xl border bg-white overflow-hidden transition-all ${open === i ? "shadow-sm" : "border-slate-100"}`}
                style={{ borderColor: open === i ? BRAND.pink : undefined }}>
                <button onClick={() => setOpen(open === i ? null : i)}
                  className="w-full flex items-center justify-between px-6 py-5 text-left">
                  <span className="font-semibold pr-4 text-sm transition-colors"
                    style={{ color: open === i ? BRAND.pink : "#1e293b" }}>
                    {f.q}
                  </span>
                  <div className="flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center transition-all"
                    style={{
                      background: open === i ? BRAND.pink : "#f1f5f9",
                      transform: open === i ? "rotate(180deg)" : "rotate(0deg)"
                    }}>
                    <svg className="w-3.5 h-3.5" style={{ color: open === i ? "white" : "#64748b" }}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          <Reveal>
            <div className="space-y-4 mb-8">
              {[
                { icon: "📞", title: "Call Us", info: "(076) 122-8682" },
                { icon: "✉️", title: "Email Us", info: "myndworkspractice@gmail.com" },
                { icon: "📸", title: "Instagram", info: "@myndworkspsychology" },
                { icon: "🌐", title: "Website", info: "www.myndworks.co.za" },
              ].map(c => (
                <div key={c.title} className="flex items-center gap-4 p-4 rounded-2xl border border-slate-100 bg-white hover:shadow-sm transition-all">
            ...
            <div className="p-5 rounded-2xl border" style={{ background: "#e0f9ff", borderColor: "#a5f3fc" }}>
              <p className="font-semibold mb-1" style={{ color: BRAND.cyan }}>🆘 In Crisis Right Now?</p>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input required type="text" placeholder="Jane Smith" value={form.name}
                          ...
                          className="w-full px-4 py-3 rounded-xl bg-white border border-slate-200 text-slate-800 text-sm placeholder-slate-400 focus:outline-none transition-all"
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <select value={form.service} onChange={e => setForm({ ...form, service: e.target.value })}
                          className="w-full px-4 py-3 rounded-xl bg-white border border-slate-200 text-slate-800 text-sm focus:outline-none transition-all">
                    ...
                    <div>
                      ...
                      <textarea rows={4} placeholder="Share as much or as little as you like…" value={form.message}
                        ...
                        className="w-full px-4 py-3 rounded-xl bg-white border border-slate-200 text-slate-800 text-sm placeholder-slate-400 focus:outline-none transition-all resize-none"
                        onFocus={e => e.target.style.borderColor = BRAND.pink}
                        onBlur={e => e.target.style.borderColor = "#e2e8f0"}/>
                    </div>
                    {status === "error" && (
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-9 h-9 rounded-xl flex items-center justify-center" style={{ background: BRAND.gradient }}>
                <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="none">
                  <path d="M12 3C7 3 3 7 3 12s4 9 9 9 9-4 9-9-4-9-9-9z" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
                  <path d="M8 14s1.5 2 4 2 4-2 4-2" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
                  <circle cx="9" cy="10" r="1.2" fill="currentColor"/>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>(076) 122-8682</li>
              <li><a href="mailto:myndworkspractice@gmail.com" className="hover:text-white transition-colors">myndworkspractice@gmail.com</a></li>
              <li><a href="mailto:sphe@myndworks.co.za" className="hover:text-white transition-colors">sphe@myndworks.co.za</a></li>
              <li><a href="https://instagram.com/myndworkspsychology" className="hover:text-white transition-colors">@myndworkspsychology</a></li>
            </ul>
            <div className="mt-5 p-3.5 rounded-xl text-xs" style={{ background: "rgba(6,182,212,0.15)", border: "1px solid rgba(6,182,212,0.3)" }}>
              <p className="font-medium mb-0.5" style={{ color: BRAND.cyan }}>Crisis Support</p>
